...
A consistência eventual nesse tipo de cenário tende a se tornar **mais complexa conforme aumenta a quantidade de fontes de eventos a serem tratadas e consolidadas**. Vamos expandir o exemplo do sistema hospitalar, onde agora precisamos recuperar todo o histórico do paciente para auditoria, faturamento e treinamento de modelos.
