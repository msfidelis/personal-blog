...
Neste artigo vamos abordar conceitos de cacheamento, ou caching, com a ótica de System Design. À medida que exploramos as vastas possibilidades de uso do caching, é fundamental compreender que, embora o conceito subjacente seja universal — armazenar dados temporariamente para reduzir o tempo de acesso —, a aplicação prática dessa técnica pode variar bastante. Existem várias estratégias e tipos de cache. No inicio desse capítulo você vai notar uma constante evolução. Vamos começar com definições generalistas que podem ser reaproveitadas na maioria dessas possibilidades, até começarmos a abordar essas estratégias de formas mais específicas com suas particularidades e vantagens.
