---
layout: post
image: assets/images/system-design/sumario-capa-2.png
author: matheus
featured: true
published: true
...
* [0. Texto Livre: Teoria das Janelas Quebradas Na Engenharia de Software](/janelas-quebradas/)
* [1. Protocolos de Rede](/protocolos-de-rede/)
* [2. Storage, Raid e I/O](/storage/)
* [3. Teorema CAP, Databases ACID e BASE](/teorema-cap/)
* [4. Teorema PACELC](/pacelc/)
* [5. Databases, Modelos de Dados e Indexação ](/databases/)
* [6. Estratégias de Cache](/caching/)
* [7. Microsserviços, Monolitos e Domínios](/monolitos-microservicos/)
* [8. Load Balancers e Proxies Reversos](/load-balancing/)
* [9. API Gateways](/api-gateway/)
* [10. Backend for Frontends (BFF's)](/bffs/)
* [11. Service Mesh Pattern](/service-mesh/)
* [12. Principios de Concorrência e Paralelismo](/concorrencia-paralelismo/)
* [13. Padrões de Comunicação Síncronos (HTTP, gRPC, RPC, REST)](/padroes-de-comunicacao-sincronos/)
* [14. Mensageria, Eventos, Streaming e Arquitetura Assincrona](/mensageria-eventos-streaming/)
* [15. Performance, Capacidade e Escalabilidade](/performance-capacidade-escalabilidade/)
* [16. Scale Cube](/cubo-escalabilidade/)
* [17. Principios de Sharding e Particionamento ](/sharding/)
* [18. Principios de Replicação de Dados](/replicacao/)
* [19. CQRS (Command-Query Responsability Segregation)](/cqrs/)
...
* [27. Capacity Planning e Teoria das Filas](/capacity-planning/)
* [28. Testes de Carga e Estresse](/load-testing/)
* [29. Single Point of Failure](/single-point-of-failure)
