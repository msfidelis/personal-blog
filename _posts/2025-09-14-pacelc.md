...
excerpt: Entenda o Teorema PACELC e como ele expande o CAP ao explicar os trade-offs entre consistência, disponibilidade e latência em sistemas distribuídos modernos, incluindo classificações como PA/EL, PC/EL e PC/EC.
seo_title: "Teorema PACELC: Explicação Completa dos Trade-offs em Sistemas Distribuídos (CAP, Consistência, Latência)"
seo_description: Um guia completo sobre o Teorema PACELC, mostrando como ele amplia o CAP ao analisar decisões entre consistência, latência e disponibilidade em bancos de dados distribuídos. Compare modelos como PA/EL, PC/EL, PA/EC e PC/EC, entenda exemplos reais como DynamoDB, Spanner e Cassandra, e aprenda quando priorizar latência ou consistência em arquiteturas distribuídas.
---
...
![PC/EL](/assets/images/system-design/pc-el.drawio.png)
