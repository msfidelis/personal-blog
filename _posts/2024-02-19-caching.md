...
Este tipo de aplicação é especialmente valioso em cargas de trabalho sensíveis à escalabilidade horizontal e que operam com [paralelização externa](/concorrencia-paralelismo/). Assim, independentemente de qual réplica crie o cache, ele estará acessível imediatamente para as demais.
